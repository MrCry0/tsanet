    ...
    def _show_guide(self):
        QMessageBox.information(
            ...
            (
                ...
                "<li><b>Spectrum</b> — sweep, signal, trace, marker, and display "
                "controls around a single live scan stream; see below.</li>"
                "<li><b>Capture</b> — fetch, save, or copy the device screenshot.</li>"
                "</ul>"
                "<b>Spectrum tab</b>"
                "<ul>"
                "<li><b>Sweep</b> — start/stop/points; Apply sends the request and "
                "reads back what the device actually applied.</li>"
                "<li><b>Signal</b> — LNA (also auto-enabled above 800 MHz), spur "
                ...
                "reference level/scale, sweep interval, Start/Stop/Single "
                "capture, and the trace statistics dialog.</li>"
                "</ul>"
                "<b>Value adjustment warnings</b>"
                "<br>If the device clamps a requested sweep value (e.g. points "
                "capped at its maximum), a warning appears showing what was "
                "actually applied instead."
                "<br><br>"
                "<b>Trace statistics</b>"
                '<br>Open with the "Stats..." button on the Spectrum tab. '
