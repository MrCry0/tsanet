#!/usr/bin/env python3
"""Run tsanet-ctl directly from the source tree.

Usage:
    python tsanet-ctl.py --help
    ./tsanet-ctl.py --address 127.0.0.1 --port 7777 devices list
...
from tsanet.controller.cli.app import main  # noqa: E402
